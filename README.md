...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dataset-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12132&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dataset-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dataset` can be installed with:

```
conda install dataset
```

It is possible to list all of the versions of `dataset` available on your platform with:
